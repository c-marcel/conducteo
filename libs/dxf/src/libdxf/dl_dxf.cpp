...
#include <libdxf/dl_attributes.h>
#include <libdxf/dl_codes.h>
#include <libdxf/dl_creationadapter.h>
#include <libdxf/dl_writer_ascii.h>
...
void DL_Dxf::addPolyline(DL_CreationInterface* creationInterface) {
    ...
    if (currentObjectType==DL_ENTITY_LWPOLYLINE) {
        ...
        creationInterface->addPolylineWithVertices(pd, vertices);
...
void DL_Dxf::addSpline(DL_CreationInterface* creationInterface) {
    ...
    creationInterface->addSplineWithVectors(sd, controlPoints, weights, fitPoints, knots);
    creationInterface->endEntity();
}
