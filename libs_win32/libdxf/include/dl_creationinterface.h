...
public:
    ...
    *
    ...
    /** Called for every polyline start */
    virtual void addPolylineWithVertices(const DL_PolylineData& data, double* vertices) = 0;
    ...
    virtual void addSplineWithVectors(const DL_SplineData&, double* controlPoints, double* weightCP, double* fitPoints, double* knots) = 0;
