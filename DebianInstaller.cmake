...
install(DIRECTORY ${CMAKE_SOURCE_DIR}/install/examples/
        DESTINATION share/doc/conducteo/examples
        OPTIONAL)
...
install(FILES ${validations_data_en10211} DESTINATION share/doc/conducteo/examples OPTIONAL)
install(FILES ${validations_data_common} DESTINATION share/doc/conducteo/examples OPTIONAL)
install(FILES ${validations_data_en10077} DESTINATION share/doc/conducteo/examples OPTIONAL)

# Tutorial.
file(GLOB_RECURSE tutorial_data "${CMAKE_SOURCE_DIR}/documentation/tutorial/*.c2d")
install(FILES ${tutorial_data} DESTINATION share/doc/conducteo/examples OPTIONAL)
